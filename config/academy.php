...
return [
    ...
    'org' => [
        ...
        'tagline' => env('ACADEMY_TAGLINE', 'DISCIPLINE • FOCUS • STRENGTH • RESPECT'),
        'footer_tagline' => env('ACADEMY_FOOTER_TAGLINE', 'TRAIN TODAY, LEAD TOMORROW.'),
        'address' => env('ACADEMY_ADDRESS', 'Ramgram-05, Parasi, Nawalparasi, Nepal'),
        'phone' => env('ACADEMY_PHONE', '9847445948'),
        'email' => env('ACADEMY_EMAIL', 'info@barefootmartialarts.com'),
        'website' => env('ACADEMY_WEBSITE', 'barefootmartialarts.com'),
        'pan' => env('ACADEMY_PAN', '143834993'),
        'vat' => env('ACADEMY_VAT', ''),
        'fonepay_terminal' => env('ACADEMY_FONEPAY_TERMINAL', '2222170017728303'),
        'fonepay_address' => env('ACADEMY_FONEPAY_ADDRESS', 'PARASI'),
        'qr_path' => env('ACADEMY_QR_PATH', 'images/qr_final.jpeg'),
        'authorized_signatory' => env('ACADEMY_SIGNATORY', 'Manish Gupta'),
    ],
